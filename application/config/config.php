...
//#############   Define all the URL links used by Frontend and Backend    ############

// Set default timezone to India (Asia)
date_default_timezone_set('Asia/Calcutta');

$config['base_url']				= "http://localhost/codebase"; //base_url index is default identified by CodeIgnitor, it cannot be change.
$config['base_path']			= "C:/xampp/htdocs/codebase";
$config['fileUploadUrl']		= "C:/xampp/htdocs/codebase/system/application/views/uploads";
