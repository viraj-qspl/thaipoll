 ...
 *
 */
class Poll_list extends Base_list {
	...
	function getInstance($argData = array()){
		...
		parent::setActionUrl($CI->config->item('pollListingBeAction'));
		//parent::setSearchFieldArr($CI->config->item('userSearchFieldBeArr'));
		parent::setDbFieldArr($CI->config->item('pollDbFieldBeArr'));
	...
	function createBreadCrumb(){
	    // Write to log file
 		log_message('info', '--------------> poll_list - creatBreadCrumb() called');		
