				...
				<tr> 
				 <td> 
				 	<div id="adm_list_head_wrap"  >
						...
						&gt;
						<?php echo ($listDataObj->getOprType()==OPR_ADD)? "Add" : (($listDataObj->getOprType()==OPR_EDIT)? "Edit" : "" ); ?> Area 
						</strong></div>
					</div>
				 </td> 
				</tr>
				...
				<tr>
				 <td> 
					...
					<?php 
						...
						$actionURL = $this->config->item('areaSaveBeAction')."/".$listDataObj->getUrlParams(); 					
					...
					<table width="100%" border="0">
                      ...
                      <tr>
                        <td width="20%"><div align="right">*Area Name:</div></td>
                      ...
                      <tr>
	                    ...
	                    <input type="hidden" name="cityId" value="<?php echo $listDataObj->getCityObj()->getId(); ?>" />
	...
	<script>
	function doCancel(){
		// simply reload the Area page
		window.location.href = "<?php echo $this->config->item('areaBeAction');  ?>";
