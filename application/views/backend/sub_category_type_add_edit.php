				...
				<tr> 
				 <td> 
				 	<div id="adm_list_head_wrap"  >
						...
						&gt; 						
						<?php echo ($listDataObj->getOprType()==OPR_ADD)? "Add" : (($listDataObj->getOprType()==OPR_EDIT)? "Edit" : "" ); ?> Subcategory Type 
						</strong></div>
					</div>
				 </td> 
				</tr>
				...
				<tr>
				 <td> 
					...
					<?php 
						...
						$actionURL = $this->config->item('subCategoryTypeSaveBeAction')."/".$listDataObj->getUrlParams(); 					
					...
					<table width="100%" border="0">
                      ...
                      <tr>
                        <td width="20%"><div align="right">*Subcategory Type Name:</div></td>
                      ...
                      <tr>
	                    ...
	                    <input type="hidden" name="subCategoryId" value="<?php echo $listDataObj->getSubCategoryObj()->getId(); ?>" />
                    </form>
	...
	function doCancel(){
		...
		window.location.href = "<?php echo $this->config->item('subCategoryTypeBeAction');  ?>";
