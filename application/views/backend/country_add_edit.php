				...
				<tr> 
				 <td> 
				 	<div id="adm_list_head_wrap"  >
						...
						&gt;  
						<?php echo ($listDataObj->getOprType()==OPR_ADD)? "Add" : (($listDataObj->getOprType()==OPR_EDIT)? "Edit" : "" ); ?> Country 
						</strong></div>
					</div>
				 </td> 
				</tr>
				...
				<tr>
				 <td> 
					...
					<?php 
						...
						$actionURL = $this->config->item('countrySaveBeAction')."/".$listDataObj->getUrlParams(); 					
					...
					<table width="100%" border="0">
                      ...
                      <tr>
                        <td width="20%"><div align="right">*Country Name:</div></td>
	...
	<script>
	function doCancel(){
		// simply reload the Country page
		window.location.href = "<?php echo $this->config->item('countryBeAction');  ?>";		
	}
